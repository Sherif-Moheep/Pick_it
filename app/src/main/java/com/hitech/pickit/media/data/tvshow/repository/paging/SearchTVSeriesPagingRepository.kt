...
import com.hitech.pickit.media.data.tvshow.datasource.paging.SearchTVSeriesPagingSource
...
SearchTVSeriesPagingRepository @Inject constructor(
    ...
    override fun pagingSource(query: String?, id: Int?): BasePagingSource<TVShow> =
        SearchTVSeriesPagingSource(
            context,
            tvShowApi,
            requireNotNull(query) { "Search query must not be null" })
}
